...
// Add mousedown event listener on window to handle clicks outside the menu
  ...
  setFocusToMenuitem(newMenuitem) {
    ...
    this.menuitemNodes.forEach(function (item) {
        // Set tabindex="-1" to make all other menu items unfocusable
        item.tabIndex = -1;
    });

    // Set tabindex="0" for the newly focused menu item to make it focusable
    newMenuitem.tabIndex = 0;
    // Programmatically apply focus to the new menu item
    newMenuitem.focus();
}
